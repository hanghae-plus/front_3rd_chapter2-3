...
import { selectedCommentAtom, showEditCommentDialogAtom } from '../../../entities/comment/model/commentAtom.js';
...
const CommentList: React.FC<CommentListProps> = ({ comments, onAddComment, onEditComment, onDeleteComment }) => {
  const { likeCommentMutation, deleteCommentMutation } = useCommentMutations();
