...
import { Close, Content, DialogContentProps, DialogOverlay, DialogPortal } from '@radix-ui/react-dialog';

interface IDialogContent extends DialogContentProps {
  className?: string;
}

export const DialogContent = forwardRef<HTMLDivElement, IDialogContent>(({ className, children, ...props }, ref) => (
  <DialogPortal>
