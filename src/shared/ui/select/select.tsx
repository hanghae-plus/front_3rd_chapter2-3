...
interface SelectContentsProps extends SelectProps {
...
export const SelectTrigger = forwardRef<HTMLButtonElement, SelectProps>(
...
export const SelectContent = forwardRef<HTMLDivElement, SelectContentsProps>(
