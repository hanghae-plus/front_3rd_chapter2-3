...
import { postsAtom, searchQueryAtom, selectedTagAtom } from "../model/postAtoms"
...
export const RenderPostTable = () => {
  ...
  const { handleDeletePost } = usePostHandler()
  const { handleOpenPostUpdate, handleOpenPostDetail, handleOpenUserDetail } = usePostDialog()
          ...
          <TableRow key={post.id}>
            ...
            <TableCell>
              <div
                ...
                onClick={() => post.author?.id && handleOpenUserDetail(post.author.id)}
              >
